    ...
    <section id="details" className="py-16 px-4 bg-cream">
      <div className="max-w-[400px] mx-auto">
        <div className="bg-[#FEFEFE] rounded-2xl p-8 md:p-10 shadow-lg shadow-stone-200/50 border border-stone-100 text-center">
          ...
          <p className="font-brush text-xl md:text-2xl text-amber-600 my-1">&amp;</p>
          <p className="font-brush text-3xl md:text-4xl text-stone-800 leading-tight mb-10">
            Anushka Sofea
          </p>
              ...
              <div className="flex items-center justify-center gap-3 mt-4">
                ...
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20.19 4.7A11.95 11.95 0 0012 0C7.52 0 3.58 2.45 1.56 6.12L1.5 6.24c-.76 1.52-1.18 3.15-1.18 4.81 0 3.14 1.23 6.1 3.46 8.33l.1.1c.34.34.7.66 1.08.96-.1.56-.57 1.17-1.12 1.79l-.4.46 1.7.08c2.08.1 4.15-.74 5.96-2.16l.05-.04h.2a12.13 12.13 0 005.85-1.5L20.19 4.7zM4.95 7.3A1.75 1.75 0 115.6 5.78c.38-.66 1.2-.9 1.86-.52.66.38.9 1.2.52 1.85a1.35 1.35 0 01-.64.64h-.01l-.22.13c-.4.2-.86.3-1.33.27a2.4 2.4 0 01-.83-.19v.01l.01-.65zm2.83 6.44a2.52 2.52 0 01-.56.37c1.33.76 2.84 1.17 4.38 1.2h.8a7.76 7.76 0 004.44-1.47 2.53 2.53 0 01-2.02.77h-.98a5.6 5.6 0 01-3.26-1.17l-.14-.12c-.37-.28-.7-.6-1-1l.35.38z" />
                  </svg>
                  <span>Waze</span>
                </a>
                <a
